function [outline_of_brain_with_slopes] = generateslopes(p, outline_of_brain)
%GENERATENORMAL Summary of this function goes here
%   Detailed explanation goes here

outline_of_brain_with_slopes = [];
for i = 1:(length(outline_of_brain)-1)
    x0= outline_of_brain(i,1);
    y0= polyval(p,x0);
    x1= outline_of_brain(i+1,1);
    y1= polyval(p,x1);
